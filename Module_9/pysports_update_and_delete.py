...
try:
    ...
    update_player = ("UPDATE player SET team_id = 2, first_name = 'Harley', last_name = 'Quinn' WHERE first_name = 'Pamela'")
    ...
    delete_player = ("DELETE FROM player WHERE first_name = 'Harley'")
